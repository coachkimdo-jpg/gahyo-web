...
const REVIEWS = [
  ...
  },
  {
    ...
    date: '2025-07-22',
    rating: 5,
    title: '가효상조 제휴 봉안당 할인 혜택까지, 기대 이상이었습니다',
    body: '아버지 장례를 치르면서 봉안당 선택을 도움받았는데, 가효상조 제휴 시설을 통해 상당한 할인 혜택을 받았습니다. 일반 시장가와 비교하면 절반 가까이 저렴하게 이용할 수 있었습니다. 장례 절차 전반에서도 불필요한 서비스를 권유하지 않고 필요한 것만 안내해 주셔서 믿음이 갔습니다. 후불제이기 때문에 장례를 모두 마친 뒤 청구서 확인하고 납부할 수 있어 심리적으로도 여유가 있었습니다.',
