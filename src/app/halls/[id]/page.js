...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    keywords: [
      '상조', '상조회사', '후불제상조회사', '상조회', '장례상조', '후불상조', '후불제상조추천', '후불상조업체', 
      '후불상조 회사', '후불상조 비용', '후불상조 후기', '후불상조 가격비교', '후불상조 상품', '후불상조회사 비교', 
      '후불상조 서비스', '비용', '상조 비용', '장례 비용', '장례', '상조 가입', '상조 서비스', '무빈소장례', 
      '가족장', '무빈소장례비용', '가족장비용', '무빈소', '무빈소가족장', '무빈소장례식', '가족장례식', 
      '국내상조회사', '상조비용', '상조 추천', '상조회 추천', '상조회사 추천', '후불제상조 추천', '후불제상조회 추천', 
      '후불제상조회사 추천', '장례준비', '기독교장례', '불교장례', '천주교장례', '상조 업체', '상조회 업체', 
      '후불 업체', '후불제 업체', '후불 상조 업체', '후불제 상조 업체', '장례비', '상조 상품', '상조회 상품', 
      '후불 상조 상품', '후불제 상조 상품', '장례업체', '상조회사서비스', '스몰장례', '무빈소상조', '상조회사비용'
    ].map(k => `${hall.name.replace(/\s+/g, '')} ${k}`),
    openGraph: {
