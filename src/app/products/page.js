...
const PRODUCTS = [
  {
    ...
    borderColor: '#d1d5db',
    rows: [
      { icon: '👥', label: '인력 지원', value: '장례지도사 1명 / 3일 파견 / 장례예식 총괄 진행 / 장지동행\n입관보조 1명 (염습, 입관 진행)\n장례도우미 미지원' },
      { icon: '🚗', label: '의전 차량', value: '[스프린터 또는 리무진(8인승)] 1대 제공\n(앰뷸런스, 유족전용 버스 등 별도 선택)' },
      { icon: '⚰️', label: '고인 용품', value: '[관] 0.6 오동관 1개\n[수의] 별도 선택 (개인 준비 또는 구매)\n[대렴] 전통 상례에 따른 궁중 한지대렴(국화) 제공' },
      { icon: '🌸', label: '입관 용품', value: '[입관수시용품 16종] 명정, 관보, 결관바, 연출꽃 등 제공\n[궁중대렴] 국화꽃 모양의 한지고깔 제공\n[위생용품] 베게, 습신, 수시포, 한지, 예단, 다라니경, 탈지면, 알코올 등' },
      { icon: '👔', label: '상복 제공', value: '[상주용품 3종] 완장, 리본, 장갑 제공\n상복 별도 선택 (남상복, 여상복)' },
      { icon: '✨', label: '특화 서비스', value: '[안내서비스] 화장예약, 제례, 장례행정, 유품정리, 장지 안내\n산재, 재산 및 상속 법률 상담 무료' },
    ],
  },
  {
    id: '270',
    ...
    rows: [
      ...
      { icon: '👔', label: '상복 제공', value: '남상복 3복 (Y셔츠, 넥타이 포함) / 여상복 5복\n완정, 두건, 행전, 상장, 근조리본 필요량 제공' },
  ...
  },
  {
    ...
    rows: [
      ...
      { icon: '🌸', label: '입관 용품', value: '[규격품] 명정, 관보, 결관바, 연출꽃 등 제공\n[궁중대렴] 국화꽃 모양의 한지고깔 제공\n[위생용품] 베게, 습신, 수시포, 한지, 예단, 다라니경, 탈지면, 알코올 등' },
      { icon: '👔', label: '상복 제공', value: '남상복 5복 (Y셔츠, 넥타이 포함) / 여상복 7복\n완정, 두건, 행전, 상장, 근조리본 필요량 제공' },
      { icon: '✨', label: '특화 서비스', value: '[특별서비스] 유가족 장례편의용품 1BOX, 꽃침대 연출 등\n[기타서비스] 방명록, 부의록, 축문, 흰장갑, 향, 양초 등 제공\n[안내서비스] 화장예약, 제례, 장례행정, 유품정리, 장지 안내' },
    ],
  },
  {
