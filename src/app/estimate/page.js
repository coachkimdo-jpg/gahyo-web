...
const GAHYO_PRODUCTS = {
  '0': {
    ...
    price: '1,700,000',
    badge: '실속 장례',
    desc: '빈소 없이 가족끌리 조용히 모시는 1~2일장',
    highlights: ['장례지도사 1명 (염습 2명 파견)', '앞블런스 관내 / 유족전용 버스 200km', '맴 100% 수의', '상복 열3 2보'],
    href: '/products'
  },
  '50-100': {
    name: '가효 270',
    ...
    highlights: ['장례도우미 4명 (10시간)', '앞블런스 + 버스 200km', '친환경 전통한지수의', '남상복 3보 / 여상복 5보'],
    href: '/products'
  },
  '100-200': {
    name: '가효 330',
    ...
    highlights: ['장례도우미 5명 (10시간)', '리무진 200km + 버스 200km', '저마수의 (저마 100%)', '남상복 5보 / 여상복 7보'],
    href: '/products'
  },
  '200-300': {
    name: '가효 430',
    ...
    highlights: ['장례도우미 6명 (10시간)', '리무진 400km + 버스 400km', '대마수의 (대마 100%)', '남상복 7보 / 여상복 9보'],
    href: '/products'
  }
};
