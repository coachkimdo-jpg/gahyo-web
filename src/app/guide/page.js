        ...
        {guideArticles[0] && (
          <Link href={`/guide/${guideArticles[0].slug}`} style={{ textDecoration: 'none', color: 'inherit' }}>
            <div className="card" style={{ display: 'flex', flexDirection: 'column', marginBottom: '2rem', borderTop: '3px solid var(--gold)', cursor: 'pointer' }}>
              <div style={{ background: featuredImg ? `url(${featuredImg}) center/cover no-repeat` : 'linear-gradient(135deg, var(--navy) 0%, var(--navy-mid) 100%)', height: '220px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', gap: '0.75rem', position: 'relative' }}>
