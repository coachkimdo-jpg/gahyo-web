...
const REVIEWS = [
  { text: '갑자기 아버지가 돌아가셔서 어쩔 줄 몰랐는데, 전화 한 통에 장례지도사가 모든 걸 알아서 해주셨어요.', name: '박○○', region: '서울 마포구' },
  { text: '선불제 상조에 가입돼 있었는데 막상 필요할 때 불투명해서 가효로 전환했어요. 가격이 명확해서 좋았습니다.', name: '정○○', region: '경기 성남시' },
  { text: '어머니 3일장을 치렀는데 견적서와 최종 청구서가 한 푼도 차이가 없었어요. 정말 드문 경험이에요.', name: '강○○', region: '부산 해운대구' },
];
              ...
              {REVIEWS.map((r, i) => (
                <div key={i} style={{
                  ...
                  <div style={{ display: 'flex', gap: '0.1rem', marginBottom: '0.25rem' }}>
                    {[1,2,3,4,5].map(s => <span key={s} style={{ color: 'var(--gold)', fontSize: '0.72rem' }}>★</span>)}
                  </div>
          ...
          <div style={{
            ...
            {status === 'success' ? (
              <div style={{ textAlign: 'center', padding: '2.5rem 0' }}>
                ...
                <div style={{ fontWeight: '800', fontSize: '1.2rem', color: 'var(--navy)', marginBottom: '0.5rem' }}>
                  신청 완료!
                </div>
              ...
              <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                ...
                <div>
                  <label htmlFor="consult-phone" style={{ display: 'block', fontWeight: '700', fontSize: '0.9rem', color: '#1e293b', marginBottom: '0.4rem' }}>
                    연락처 <span style={{ color: 'var(--gold-dark)' }}>*</span>
                  </label>
                  <input
                    id="consult-phone"
                    type="tel"
                ...
                <label style={{
                  ...
                  <span
                    ...
                    style={{
                      ...
                      background: agreed ? 'var(--gold)' : 'white',
                ...
                <div style={{ textAlign: 'center', fontSize: '0.82rem', color: '#475569' }}>
                  급하신 분은 바로 전화하세요 →{' '}
                  <a href="tel:1551-5718" style={{ color: 'var(--gold-dark)', fontWeight: '800', textDecoration: 'none' }}>
                    1551-5718
                  </a>
                </div>
