    ...
    <div style={{ background: 'var(--gray-bg)', minHeight: '100vh', padding: '2rem 0' }}>
      ...
      <div className="container" style={{ padding: '0 1.25rem' }}>
        ...
        <div style={{ marginTop: '3rem', background: 'linear-gradient(135deg, var(--navy), var(--navy-dark))', borderRadius: '16px', padding: '2rem', textAlign: 'center', color: 'white' }}>
          ...
          <a href="tel:1551-5718" style={{ display: 'inline-block', padding: '0.9rem 2.5rem', background: 'linear-gradient(135deg, var(--gold), var(--gold-dark))', color: 'white', borderRadius: '999px', fontWeight: '800', fontSize: '1.05rem', textDecoration: 'none', boxShadow: '0 4px 16px rgba(133,90,28,0.4)' }}>
            📞 1551-5718 지금 전화하기
          </a>
        </div>
      </div>
