...
const GAHYO_PRODUCTS = {
  '0': {
    ...
    highlights: ['장례지도사 1명 (입관지도사 1명 파견)', '스프린터 8인승 리무진 1대', '수의, 납골함, 상복 미포함', '입관수시용품 16종 (오동나무 화장 규격관 포함)'],
    href: '/products'
  },
  '50-100': {
    name: '가효 265',
    ...
    highlights: ['장례도우미 3명(총 30시간)', '앰뷸런스 + 버스 200km', '친환경 전통한지수의', '남상복 2복 / 여상복 2복'],
    href: '/products'
  },
  '100-200': {
    name: '가효 334',
    ...
    highlights: ['장례도우미 4명(총 40시간)', '리무진 200km + 버스 200km', '저마수의', '남상복 3복 / 여상복 3복'],
    href: '/products'
  },
  '200-300': {
    name: '가효 363',
    ...
    highlights: ['장례도우미 5명(총 50시간)', '리무진 400km + 버스 400km', '대마수의', '남상복 4복 / 여상복 4복'],
    href: '/products'
  }
};
        ...
        <div className="card" style={{ padding: '3rem 2.5rem' }}>
          ...
          {step === 4 && result && selectedHall && !loadingEstimate && (
            <div>
              ...
              <div style={{ background: 'linear-gradient(135deg, var(--navy) 0%, var(--navy-mid) 100%)', borderRadius: 'var(--radius-lg)', padding: '2.5rem', textAlign: 'center', marginBottom: '2rem', color: 'white', boxShadow: 'var(--shadow-lg)' }}>
